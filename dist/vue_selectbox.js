    ...
    return {
        ...
        computed: {
            ...
            config: function() {
                var defaults = {
                        ...
                        reset_input_after_add: true,        //reset filter input after adding a value
        ...
        methods: {
            ...
            set_value: function(value) {
                if (this.config.reset_input_after_add) {
                    this.input = "";
                }
                if (!this.is_selectable(value)) {
                    return;
